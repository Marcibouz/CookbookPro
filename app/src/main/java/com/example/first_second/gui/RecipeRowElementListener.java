...
public class RecipeRowElementListener implements View.OnClickListener{
    private Fragment fragment;
    private String id;
    private String recipe_name;
    private String ingredients;
    private String directions;
    public RecipeRowElementListener(String id, String recipe_name, String ingredients, String directions,
                                    Fragment fragment){
        this.id = id;
